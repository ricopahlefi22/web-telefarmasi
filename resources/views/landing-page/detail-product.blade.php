...
<body>
    <div class="body-wrapper">
        ...
        <div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image"
            data-bs-bg="{{ asset('assets-landing/assets-landing/img/slider/slider-1.jpg') }}') }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="ltn__shop-details-img-gallery">
                                        <div class="ltn__shop-details-large-img">
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/1.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/1.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/2.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/2.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/3.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/3.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/4.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/4.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/5.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/5.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/6.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/6.png') }}" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="{{ asset('assets-landing/img/product/7.png') }}"
                                                    data-rel="lightcase:myCollection">
                                                    <img src="{{ asset('assets-landing/img/product/7.png') }}" alt="Image">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="modal-product-info shop-details-info pl-0">
                                        ...
                                        <div class="ltn__safe-checkout">
                                            ...
                                            <img src="{{ asset('assets-landing/img/icons/payment-2.png') }}" alt="Payment Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="ltn__comment-inner">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div class="ltn__comment-item clearfix">
                                                            <div class="ltn__commenter-img">
                                                                <img src="{{ asset('assets-landing/img/testimonial/2.jpg') }}"
                                                                    alt="Image">
                                                            </div>
                                                            <div class="ltn__commenter-comment">
                                                                <h6><a href="#">Adam Smit</a></h6>
                    ...
                    <div class="col-lg-4">
                        <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar">
                            ...
                            <div class="widget ltn__banner-widget">
                                <a href="shop.html"><img src="{{ asset('assets-landing/img/banner/2.jpg') }}" alt="#"></a>
                            </div>
                        </aside>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row ltn__related-product-slider-one-active slick-arrow-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/7.png') }}"
                                        alt="#"></a>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/8.png') }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/9.png') }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/10.png') }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/5.png') }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="{{ asset('assets-landing/img/product/6.png') }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('assets-landing/img/product/4.png') }}" alt="#">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12">
                            ...
                            <div class="ltn__quick-view-modal-inner">
                                <div class="modal-product-item">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('assets-landing/img/product/1.png') }}" alt="#">
                                            </div>
                                            <div class="modal-product-info">
                                            ...
                                            <div class="additional-info d-none">
                                                ...
                                                <div class="payment-method">
                                                    <img src="{{ asset('assets-landing/img/icons/payment.png') }}" alt="#">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="ltn__quick-view-modal-inner">
                                <div class="modal-product-item">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('assets-landing/img/product/7.png') }}" alt="#">
                                            </div>
                                            <div class="modal-product-info">
                                                <h5><a href="product-details.html">Digital Stethoscope</a></h5>
                                                <p class="added-cart"><i class="fa fa-check-circle"></i>
